...
electron_1.contextBridge.exposeInMainWorld("electronAPI", {
    ...
    startRecording: () => electron_1.ipcRenderer.invoke("start-realtime-recording", true),
    stopRecording: () => electron_1.ipcRenderer.invoke("stop-realtime-recording"),
    ...
    // --- Thinking Mode ---
    setThinkingMode: (enabled) => electron_1.ipcRenderer.invoke("set-thinking-mode", enabled),
    getThinkingMode: () => electron_1.ipcRenderer.invoke("get-thinking-mode"),
    // --- Event Listeners ---
